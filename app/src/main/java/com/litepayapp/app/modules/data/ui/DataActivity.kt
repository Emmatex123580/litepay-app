package com.litepayapp.app.modules.`data`.ui
...
import com.litepayapp.app.databinding.ActivityDataBinding
...
import com.litepayapp.app.modules.`data`.`data`.viewmodel.DataVM
import kotlin.String
import kotlin.Unit

class DataActivity : BaseActivity<ActivityDataBinding>(R.layout.activity_data) {
  private val viewModel: DataVM by viewModels<DataVM>()
  ...
  companion object {
    const val TAG: String = "DATA_ACTIVITY"


    fun getIntent(context: Context, bundle: Bundle?): Intent {
      val destIntent = Intent(context, DataActivity::class.java)
