package com.litepayapp.app.modules.referals.`data`.model

import com.litepayapp.app.R
import com.litepayapp.app.appcomponents.di.MyApp
import kotlin.String

data class ReferalsModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtYouhavenotre: String? =
      MyApp.getInstance().resources.getString(R.string.msg_you_have_not_re)
  ,
  /**
   * TODO Replace with dynamic value
   */
