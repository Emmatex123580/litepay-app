...
class SpinnerFrame627042FourAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerFrame627042FourModel>
) : ArrayAdapter<SpinnerFrame627042FourModel>(mContext, layoutResource, allItems) {
