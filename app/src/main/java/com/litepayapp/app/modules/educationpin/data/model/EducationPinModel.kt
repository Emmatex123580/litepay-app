package com.litepayapp.app.modules.educationpin.`data`.model

import com.litepayapp.app.R
import com.litepayapp.app.appcomponents.di.MyApp
import kotlin.String

data class EducationPinModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtOops: String? = MyApp.getInstance().resources.getString(R.string.lbl_oops)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtIncorrectPIN: String? = MyApp.getInstance().resources.getString(R.string.lbl_incorrect_pin)
