package com.litepayapp.app.modules.electricitytwo.ui

import androidx.activity.viewModels
import com.litepayapp.app.R
import com.litepayapp.app.appcomponents.base.BaseActivity
import com.litepayapp.app.databinding.ActivityElectricityTwoBinding
...
import com.litepayapp.app.modules.electricitytwo.`data`.viewmodel.ElectricityTwoVM
import kotlin.String
import kotlin.Unit

class ElectricityTwoActivity :
    BaseActivity<ActivityElectricityTwoBinding>(R.layout.activity_electricity_two) {
  private val viewModel: ElectricityTwoVM by viewModels<ElectricityTwoVM>()
  ...
  override fun onInitialized(): Unit {
    ...
    binding.electricityTwoVM = viewModel
  }
  ...
  companion object {
    const val TAG: String = "ELECTRICITY_TWO_ACTIVITY"
