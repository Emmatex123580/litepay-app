...
import com.litepayapp.app.databinding.ActivitySignInFiveBinding
import com.litepayapp.app.modules.signinfive.`data`.viewmodel.SignInFiveVM
import java.util.regex.Matcher
import java.util.regex.Pattern
import kotlin.String
import kotlin.Unit

class SignInFiveActivity : BaseActivity<ActivitySignInFiveBinding>(R.layout.activity_sign_in_five) {
  ...
  ActivityResultCallback {
    ...
    private val viewModel: SignInFiveVM by viewModels<SignInFiveVM>()

    override fun onInitialized(): Unit {
      viewModel.navArguments = intent.extras?.getBundle("bundle")
      startSmartUserConsent()
      binding.signInFiveVM = viewModel
    }
    ...
    companion object {
      const val TAG: String = "SIGN_IN_FIVE_ACTIVITY"
