...
class SpinnerFrame627042OneAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerFrame627042OneModel>
) : ArrayAdapter<SpinnerFrame627042OneModel>(mContext, layoutResource, allItems) {
