package com.litepayapp.app.modules.signinseven.ui
...
import com.litepayapp.app.databinding.ActivitySignInSevenBinding
import com.litepayapp.app.modules.signinseven.`data`.viewmodel.SignInSevenVM
import java.util.regex.Matcher
import java.util.regex.Pattern
import kotlin.String
import kotlin.Unit

class SignInSevenActivity :
    BaseActivity<ActivitySignInSevenBinding>(R.layout.activity_sign_in_seven) {
  ...
  ActivityResultCallback {
    ...
    private val viewModel: SignInSevenVM by viewModels<SignInSevenVM>()

    override fun onInitialized(): Unit {
      viewModel.navArguments = intent.extras?.getBundle("bundle")
      startSmartUserConsent()
      binding.signInSevenVM = viewModel
    }
    ...
    companion object {
      const val TAG: String = "SIGN_IN_SEVEN_ACTIVITY"
